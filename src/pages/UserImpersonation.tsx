    ...
    <div className="max-w-2xl">
      ...
      <div className="rounded-xl border border-neutral-800 bg-neutral-900 p-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="p-2 rounded-lg bg-neutral-800"><Eye className="h-5 w-5 text-neutral-500" /></div>
          <h3 className="text-lg font-semibold text-white">Impersonate User</h3>
          <span className="text-xs px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-400 border border-amber-800">Super Admin Only</span>
        </div>
          ...
          <div className="mt-3 space-y-1">
            {results.map(u => (
              <div key={u.id}
                ...
                className="flex items-center gap-3 p-3 rounded-lg bg-neutral-900 hover:bg-neutral-800 cursor-pointer transition-colors"
              >
        ...
        {selectedUser && (
          <>
            ...
            <div className="mt-4 rounded-lg border border-amber-800 bg-amber-500/10 p-3">
            ...
            <div className="mt-4 flex gap-3">
              ...
              <button onClick={() => setSelectedUser(null)} className="flex items-center gap-2 px-4 py-2 bg-neutral-950 border border-neutral-700 text-neutral-300 hover:bg-neutral-800 rounded-lg text-sm transition-colors">
                Cancel
              </button>
            </div>
          </>
