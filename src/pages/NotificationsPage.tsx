    ...
    <div className="max-w-3xl">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <button onClick={fetchNotifications} className="flex items-center gap-2 rounded-lg border border-neutral-800 px-3 py-2 text-sm text-neutral-500 hover:text-white transition-colors">
            <RefreshCw className="h-4 w-4" />
          </button>
          {unreadCount > 0 && (
            <button onClick={markAllRead} className="flex items-center gap-2 rounded-lg border border-neutral-800 px-4 py-2 text-sm text-neutral-500 hover:text-white transition-colors">
              <CheckCheck className="h-4 w-4" /> Mark all read
            </button>
          )}
          <div className="flex items-center gap-2 rounded-lg bg-neutral-800 border border-neutral-800 px-4 py-2 text-sm">
          ...
          return (
            <div
              ...
              className={`flex items-start gap-4 rounded-xl border p-4 cursor-pointer transition-colors ${
                n.is_read ? "border-neutral-800 bg-neutral-900" : "border-neutral-700 bg-neutral-800"
              }`}
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className={`text-sm font-medium ${n.is_read ? "text-neutral-500" : "text-white"}`}>{n.title}</span>
