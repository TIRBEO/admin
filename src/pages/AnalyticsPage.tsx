  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-white">{app.name} Analytics</h1>
      </div>

      {loading ? (
        <div className="grid grid-cols-4 gap-4">
          {[1, 2, 3, 4].map(i => (
            <div key={i} className="h-28 rounded-xl bg-neutral-800 border border-neutral-800" />
          ))}
        </div>
      ) : (
        <>
