    ...
    return (
      <div className="p-6">
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-6 text-center text-neutral-500">
          <Settings className="w-12 h-12 mx-auto mb-3 text-neutral-700" />
    ...
    <div className="p-6 max-w-3xl">
      ...
      <div className="space-y-6">
        {schemaKeys.map(sectionKey => {
          ...
          return (
            <div key={sectionKey} className="rounded-xl border border-neutral-800 bg-neutral-900/50 overflow-hidden">
              <div className="px-6 py-4 border-b border-neutral-800">
                <h2 className="text-sm font-semibold text-neutral-200">{section.label}</h2>
              </div>
    ...
    return (
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={`w-10 h-5 rounded-full transition-colors relative ${value ? "bg-indigo-600" : "bg-neutral-700"}`}
        >
